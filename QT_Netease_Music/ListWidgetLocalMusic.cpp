...
void ListWidgetLocalMusic::initTitle()
{
    ...
    m_singalBtn->setToolTip(QStringLiteral("歌手"));
    ...
    m_cdBtn->setToolTip(QStringLiteral("专辑"));
    ...
    m_dirBtn->setToolTip(QStringLiteral("文件夹"));
...
void ListWidgetLocalMusic::initStack()
{
    ...
    m_searchEdit->setPlaceholderText(QStringLiteral("搜索本地音乐"));
