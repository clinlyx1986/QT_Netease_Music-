...
void TitleBar::initTitle()
{
    ...
    leftBtn->setToolTip(QStringLiteral("后退"));
    ...
    rightBtn->setToolTip(QStringLiteral("前进"));
    ...
    searchEdit->setPlaceholderText(QStringLiteral("搜索音乐，歌手，歌词，用户"));
    ...
    loginBtn->setText(QStringLiteral("未登录"));
    ...
    miniBtn->setToolTip(QStringLiteral("mini模式"));
    ...
    minimumBtn->setToolTip(QStringLiteral("最小化"));
