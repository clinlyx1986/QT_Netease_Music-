...
void ListWidgetFindMusic::init()
{
    ...
    recommendBtn = new QPushButton(QStringLiteral("个性推荐"));
    ...
    songListBtn = new QPushButton(QStringLiteral("歌单"));
    ...
    radioBtn = new QPushButton(QStringLiteral("主播电台"));
    ...
    rankBtn = new QPushButton(QStringLiteral("排行榜"));
    ...
    singleBtn = new QPushButton(QStringLiteral("歌手"));
    ...
    newMusicBtn = new QPushButton(QStringLiteral("最新音乐"));
    ...
    m_animationFrame1->resize(798, 266);
    //m_animationFrame2 = new AnimationWidget(personal_widget);
    lay->addWidget(m_animationFrame1);
    //lay->addWidget(m_animationFrame2);
    QLabel* label_recommend = new QLabel(QStringLiteral("推荐歌单"), this);
    lay->addWidget(label_recommend);
