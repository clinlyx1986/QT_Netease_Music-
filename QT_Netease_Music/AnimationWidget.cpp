    ...
    : QFrame(parent)
{
    ...
    int pos_center_ystart=(height-center_height)/2;
    center_rect.setRect(pos_center_xstart,pos_center_ystart,center_width,center_height);
    center_label = new QLabel(this);
    center_label->setPixmap(label_group[0]);
    center_label->setGeometry(pos_center_xstart,pos_center_ystart,center_width,center_height);

    int pos_left_xstart = pos_center_xstart - margin_width;
    int pos_left_ystart = pos_center_ystart + center_height - margin_height;
    ...
    int pos_right_ystart = pos_center_ystart + center_height - margin_height;
    ...
    transferBar->setGeometry(pos_center_xstart+center_width/2-40,pos_center_ystart+center_height+10,17*image_count*2,24);
